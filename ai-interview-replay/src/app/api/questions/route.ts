...
import { validateQuestionsRequest } from "@/lib/schemas";
import { buildQuestionsPrompt, SYSTEM_PROMPT } from "@/lib/ai/prompts";
import { callLLM } from "@/lib/ai/provider";
import { sanitizeJsonBlock } from "@/lib/ai/report-normalizer";

export async function POST(req: NextRequest) {
  try {
    const validated = validateQuestionsRequest(await req.json());
